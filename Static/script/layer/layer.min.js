function scrollStop(){ var scrTop = $(window).scrollTop();$(window).scroll(function(){if($(".xubox_shade").length>0){$(window).scrollTop(scrTop);}});}

/**
 * 创建人：tanghomvee
 * 创建时间：2015-04-28
 * JS获取URL地址
 * @returns 返回URL 如：http://localhost:8080/webPrjct
 */
