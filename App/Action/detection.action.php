...
class DetectionAction extends AppAction
{
    ...
    public $magic = array(
        1 => '商标存在被无效风险，若要购买，建议在协议中进行责任约定，例如：商标被无效后的赔偿条款，将风险降到最低。',
        2 => '商标存在已无效风险，若要购买，请核实状态的真实性，与卖方确认后续是否有行政诉讼流程的相关资料，确保商标有效后再行购买；',
        3 => '商标存在被无效风险，若要购买，建议在协议中进行责任约定，例如：商标被无效后的赔偿条款，将风险降到最低。',
        4 => '商标存在被无效风险，若要购买，建议在协议中进行责任约定，例如：商标被无效后的赔偿条件，将风险降到最低。',
        5 => '商标存在已无效风险，若要购买，请核实状态的真实性，与卖方核实后续是否有行政诉讼流程的相关资料，确保商标有效后再行购买；',
        6 => '商标存在被无效风险，若要购买，建议在协议中进行责任约定，例如：商标被无效后的赔偿条款，将风险降到最低。',
        7 => '商标存在被无效风险，若要购买，建议在协议中进行责任约定，例如：商标被无效后的赔偿条件，将风险降到最低。',
        8 => '商标存在已无效风险，若要购买，请核实状态的真实性，与卖方确认后续是否有行政诉讼流程的相关资料，确保商标有效后再行购买；',
        9 => '商标存在被无效风险，若要购买，建议与卖家沟通需马上终止注销流程以确保商标有效。并在协议中进行责任约定，例如：商标被无效后的赔偿条款，将风险降到最低。',
        10 => '商标存在被无效风险，若要购买，请与卖家沟通注销的部分商品/服务分别是哪些，确保购买商标的有效性后再行购买。',
        11 => '商标存在已无效风险，若要购买，请核实状态的真实性，与卖方确认后续是否有行政诉讼流程的相关资料，确保商标有效后再行购买。',
        12 => '商标存在权利不稳定风险，若要购买，建议低价购买，或在协议中进行责任约定，例如：商标注册不成功的赔偿条款，将风险降到最低。',
        13 => '商标存在已无效风险，若要购买，请核实状态的真实，确保商标有效后再行购买；',
        14 => '商标存在质押风险，若要购买，请与卖方确认质押是否解除，建议在协议中进行责任约定，将风险降到最低。',
        15 => '商标存在质押风险，若要购买，请与卖方确认质押是否解除，建议在协议中进行责任约定，将风险降到最低。',
        16 => '商标存在冻结风险，若要购买，请与卖方确认冻结是否解除，建议在协议中进行责任约定，将风险降到最低。',
        17 => '商标存在转让流程，若要购买，请与卖方确认转让流程是否完结，避免一标多卖的情况，建议在协议中进行责任约定，将风险降到最低。',
        18 => '商标存在转让流程，若要购买，请与卖方确认转让流程是否完结，避免一标多卖的情况，建议在协议中进行责任约定，将风险降到最低。',
        19 => '商标存在许可流程，若要购买 ，请与卖方确认许可合同条约是否限制转让，并将转让事宜通知被许可方，建议在协议中进行责任约定，将风险降到最低。',
        20 => '商标存在许可流程，若要购买 ，请与卖方确认许可合同条约是否限制转让，并将转让事宜通知被许可方，建议在协议中进行责任约定，将风险降到最低。',
        21 => '商标存在许可流程，若要购买 ，请与卖方确认许可合同条约是否限制转让，并将转让事宜通知被许可方，建议在协议中进行责任约定，将风险降到最低。',
        22 => '商标存在续展流程，若要购买，建议在协议中进行责任约定，例如：若续展不成功，导致商标无效的赔偿条款，将风险降到最低。',
